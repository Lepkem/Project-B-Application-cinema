...
namespace Cinema
{
    ...
    class RoomParser
    {
        ...
        /// <returns></returns>
        public static RoomV2 LoadFromJson(string file)
        {
            string FileContentString = System.IO.File.ReadAllText(file);
            RoomV2 DeserializedS = JsonConvert.DeserializeObject<RoomV2>(FileContentString); // here I made instances of classes from a JSON string in a list of class movie
