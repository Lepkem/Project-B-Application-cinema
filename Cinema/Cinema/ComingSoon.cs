...
namespace Cinema
{
    ...
    {
        string ShowComingSoon(string filename, int monthsUntilRelease =2);
    }

    public class ComingSoon : IComingSoon
    {
        public string ShowComingSoon(string filename, int monthsUntilRelease =2)
        {
            ...
            foreach (var item in DeserializedS)
            {
                ...
                else
                {
                    ...
                    Environment.ExitCode =
                        1; // I wanted the console app to stop with invalid values https://stackoverflow.com/questions/155610/how-do-i-specify-the-exit-code-of-a-console-application-in-net
                }
